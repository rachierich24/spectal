    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[999] flex flex-col items-center justify-center bg-spectal-red text-spectal-mint"
        >
          <div className="relative flex flex-col items-center">
            ...
            <motion.div
              ...
              className="w-4 h-4 bg-spectal-mint rounded-full mb-8 shadow-[0_0_30px_#DDECC4]"
            />
