...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl w-full mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col space-y-3">
            {[
              ...
              <a
                ...
                className="font-black tracking-widest text-[13px] uppercase text-spectal-mint hover:text-spectal-red transition-all duration-300 w-fit"
              >
                {link.label}
              </a>
            ))}
        ...
        <div className="flex items-center gap-4 mb-4 z-10">
          ...
          <a
            href="#"
            data-interactive="true"
            className="flex items-center space-x-2 bg-black border border-white/10 hover:border-white/30 rounded-lg px-4 py-2 hover:bg-white/5 transition-all duration-300"
          >
            ...
            <div className="flex flex-col text-left leading-none font-sans">
              <span className="text-[8px] uppercase tracking-wider text-white/50">Download on the</span>
          ...
          >
            ...
            <div className="flex flex-col text-left leading-none font-sans">
              <span className="text-[8px] uppercase tracking-wider text-white/50">GET IT ON</span>
      ...
      {/* Massive Scroll-Reveal 'spectal' Text with Logo Mark, styled like Quoti */}
      <motion.div
        initial="hidden"
        whileInView="visible"
<<<<<<< Updated upstream
